 ...
 */
{
  ...
  class Slideshow {
    ...
    init() {
      ...
      this.DOM.nav = this.DOM.el.querySelector(".arr");
      ...
      this.DOM.nextCtrl = this.DOM.nav.querySelector(".next_arrow");
      this.DOM.prevCtrl = this.DOM.nav.querySelector(".prev_arrow");
      this.current = 0;
      this.createFrame();
      this.initEvents();
    }
